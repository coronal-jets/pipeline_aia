...
if keyword_set(presets_file) then begin
    ...
    presets.MIN_ASPECT_3D = asu_get_safe_json_key(presets_data, "MIN_ASPECT", presets.MIN_ASPECT_3D)
    presets.MIN_ASPECT_AREA = asu_get_safe_json_key(presets_data, "MIN_ASPECT", presets.MIN_ASPECT_AREA)
