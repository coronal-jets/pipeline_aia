...
pipeline_aia_irc_principale_comps, x, y, vx, vy, caspect = caspect, waspect = waspect, tot_lng = tot_lng, av_width = av_width
...
;        pipeline_aia_irc_get_cluster_coords, c, k, x, y
        ...
        x = transpose(xy[0, *])
        y = transpose(xy[1, *])
        pipeline_aia_irc_principale_comps, x, y, vx, vy, vbeta = vbeta, rotx = rotx, roty = roty, caspect = caspect, baspect = baspect, waspect = waspect
