pro pipeline_aia_irc_process, rd, par, snaps, pos, seed

snaps = list()

pipeline_aia_irc_get_mask, rd, par.sigma1, cmask
pipeline_aia_irc_cluster, cmask, 1, clust
pipeline_aia_irc_cardinality_filter, clust, par.card1, rd = rd
